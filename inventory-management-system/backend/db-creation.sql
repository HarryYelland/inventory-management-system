...
CREATE TABLE IF NOT EXISTS Staff(Staff_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Username VARCHAR(64) NOT NULL, `Password` VARCHAR(128) NOT NULL, User_Privileges TINYINT(1), Is_Active TINYINT(1));
